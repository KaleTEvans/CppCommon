...
{
    return fmt::vformat(pattern, fmt::make_wformat_args(args...));
}
...
{
    fmt::vprint(pattern, fmt::make_wformat_args(args...));
}
...
{
    fmt::vprint(stream, pattern, fmt::make_wformat_args(args...));
}
